...
## 🎯 다음 세션 시작 가이드
1. **v1.0.5 태그 푸시 → GitHub Actions 빌드 → Draft Publish** (사용자 트리거 대기)
2. **v1.0.5 NOTICE 작성** (조용한 정비 톤, v1.0.4 NOTICE 양식 재사용)
...
| **v1.0.5** | **Actions v5 + 그레이딩 timeout 120 + 가면 5곳 통일 (사용자 가시 변경 0)** | ⏳ **커밋 완료, 태그 푸시 대기** (2026-04-30) |
